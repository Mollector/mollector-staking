      ...
      >
        ...
        <main className={styles.main}>
          ...
          <div style={{textAlign: 'center', marginTop: 20, color: '#239ef7', fontWeight: 'normal'}}>
            <a href='https://docs.mollector.com/staking-events/mol-staking-guide' target="_blank">Help</a> | <a href='https://docs.mollector.com/staking-events/terms-of-services' target="_blank">Terms & Conditions</a> | <a href='https://t.me/MollectorGame' target="_blank">Telegram</a>
          </div>
          <br/>
        </main>
        {/* <Footer /> */}
